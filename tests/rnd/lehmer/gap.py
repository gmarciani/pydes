...
from rnd.tests.gap import statistics, critical_min, critical_max, error, plot
...
def test():
    ...
    # Test
    data = statistics(GENERATOR, STREAMS, SAMSIZE, BINS, A, B)
    ...
    # Plot
    filename = '%s/%s.%s' % (PLOT_DIR, 'test-independence-gap', PLOT_EXT)
