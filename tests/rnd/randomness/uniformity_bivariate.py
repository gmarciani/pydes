...
from rnd.randomness.uniformity_bivariate import statistics, critical_min, critical_max, error, plot
...
def test():
    ...
    # Plot
    filename = '%s/%s.%s' % (PLOT_DIR, 'test_uniformity_bivariate', PLOT_EXT)
