...
from rnd.tests.permutation import observations, chisquare, critical_min, critical_max, plot
...
def test():
    ...
    # Plot
    plot('Test of Independence - Permutation', data, mn, mx)
    #py.plot(figure, filename='../resources/randomness/test-independence-permutation.html', auto_open=AUTO_OPEN)
