...
from rnd.tests.uniformity_univariate import observations, chisquare, critical_min, critical_max, plot
...
def test():
    ...
    # Plot
    plot('Test of Uniformity - Univariate', data, mn, mx)
    #py.plot(figure, filename='../resources/randomness/test-uniformity-univariate.html', auto_open=AUTO_OPEN)
