%********************************************************************************
% Title: Demule: the simpe but cool performance modelling suite
%
% Exam: Performance Modelling of Computer Systems and Networks (PMCSN)
%
...
\conferenceinfo{PMCSN '16}{Septermber 22, 2016, Rome, Italy}
...
\title{Demule: the simple but cool performance modelling suite}
