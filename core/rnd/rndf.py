...
"""
 ...
 # * continuous rnd variables.
 # *
 # * The following notational conventions are used
 # *                 x : possible value of the rnd variable
 # *                 u : real variable (probability) between 0.0 and 1.0 
 # *  a, b, n, p, m, s : distribution-specific parameters
 # *
 # * There are pdf's, cdf's and idf's for 6 discrete rnd variables
 # *
 ...
 # *      Poisson(m)         0...       m            m
 # *
 # * and for 7 continuous rnd variables
 # *
