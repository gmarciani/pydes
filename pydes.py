...
@click.option("--outdir", default=modulus.DEFAULT_OUTDIR, show_default=True, type=click.Path(exists=False), help="Output directory.")
@click.pass_context
...
@click.option("--outdir", default=mulfind.DEFAULT_OUTDIR, show_default=True, type=click.Path(exists=False), help="Output directory.")
@click.pass_context
...
@click.option("--outdir", default=jumpfind.DEFAULT_OUTDIR, show_default=True, type=click.Path(exists=False), help="Output directory.")
@click.pass_context
def find_jumpers(ctx, modulus, multiplier, streams, outdir):
    logger.info("Executing: {}".format(jumpfind.__file__))
    logger.info("Arguments: modulus={} | multiplier={} | streams={} | outdir={}".format(modulus, multiplier, streams, outdir))
...
@click.option("--outdir", default=mulcheck.DEFAULT_OUTDIR, show_default=True, type=click.Path(exists=False), help="Output directory.")
@click.pass_context
...
@click.option("--outdir", default=spectral.DEFAULT_OUTDIR, show_default=True, type=click.Path(exists=False), help="Output directory.")
@click.pass_context
def test_spectral(ctx, modulus, multiplier, samsize, interval, outdir):
    logger.info("Executing: {}".format(spectral.__file__))
    logger.info("Arguments: modulus={} | multiplier={} | samsize={} | interval={} | outdir={}".format(modulus, multiplier, samsize, interval, outdir))
...
@click.option("--confidence", default=extremes.DEFAULT_CONFIDENCE, show_default=True, type=float, help="Confidence level.")
@click.option("--d", default=extremes.DEFAULT_D, show_default=True, type=int, help="Test parameter D.")
@click.option("--outdir", default=extremes.DEFAULT_OUTDIR, show_default=True, type=click.Path(exists=False), help="Output directory.")
@click.pass_context
def test_extremes(ctx, modulus, multiplier, jumper, streams, samsize, bins, confidence, d, outdir):
    ...
    logger.info("Arguments: modulus={} | multiplier={} | jumper={} | streams={} | samsize={} | bins={} | confidence={} | d={} | outdir={}"
                .format(modulus, multiplier, jumper, streams, samsize, bins, confidence, d, outdir))
...
@click.option("--multiplier", default=kolmogorov_smirnov.DEFAULT_MULTIPLIER, show_default=True, type=int, help="Multiplier.")
...
@click.option("--test", default=kolmogorov_smirnov.DEFAULT_TEST, show_default=True, type=click.Choice([kolmogorov_smirnov.SUPPORTED_TESTS], case_sensitive=False), help="Underlying test of randomness.")
@click.option("--test-params", default=kolmogorov_smirnov.DEFAULT_TEST_PARAMS, show_default=True, type=click.STRING, help="Params for the underlying test of randomness.")
@click.option("--outdir", default=kolmogorov_smirnov.DEFAULT_OUTDIR, show_default=True, type=click.Path(exists=False), help="Output directory.")
@click.pass_context
def test_kolmogorov_smirnov(ctx, modulus, multiplier, jumper, streams, test, test_params, outdir):
    ...
    logger.info("Arguments: modulus={} | multiplier={} | jumper={} | streams={} | test={} | test_params={} | outdir={}"
                .format(modulus, multiplier, jumper, streams, test, test_params, outdir))
    generator = MarcianiMultiStream(modulus=modulus, multiplier=multiplier, jumper=jumper, streams=streams)
